...
<div style="border :1px solid none; width : 400px; height : 150px;" class="form">
		...
		<center>
			<div>
				...
				<%=session.getAttribute("college") %>과 
		 ...
		 <form style="display:none;  overflow:hidden; position:realative"><br><br>
		    ...
		    <button type="button" onclick="location.href='delete.jsp' " style="background-color : #43A047">수강신청 삭제</button>
		...
		*/
		...
		<div class="form_caja">
			<table align="center" style="overflow:hidden; position:realative">
				<thead><tr><td>학수번호</td><td>과목명</td><td>시간</td><td>수강취소</td></tr></thead>
				<% for(int k=0;k<i2;k++){%>
