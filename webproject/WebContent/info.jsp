...
<body><div style="border :1px solid none; width : 400px; height : 150px;" class="form">
	    ...
	    <form style="display:none"><br><br>
	        ...
	        <button type="button" id="bbb2" onclick="location.href='delete.jsp' ">수강신청 삭제</button>
	      	...
	      	<button type="button" onclick="location.href='info.jsp' " style="background-color : #43A047">마이페이지</button>
	...
	<div class="fixed">
	    ...
	    <%=college%> 소속  <%=id%> <%=name%>님의 정보를 수정합니다.<br><br><Br>
		...
		<form action="/practiceweb/BoardServlet"  method="post" >	
			<input type="hidden"  name="id" value=<%=id %>>
				<table border="1" align="center">
	 				<tr> 
	      				<td class="label" align="center" bgcolor=#FFDAB9> 이름 </td>
	       				<td class="field"><input type="text" name="name"></td>
	        		</tr>
	 
	 				<tr>
	   					<td class="label" align="center" bgcolor=#FFDAB9> 비밀번호 </td>
	    				<td class="field"><input type="password" name="pw"></td>
	     			</tr>
	      
	         		<tr>
	          			<td class="label" align="center" bgcolor=#FFDAB9 > 소속 단과 대학 </td>
	          			<td class="field"><input type="text" name="college" ></td> 
	           		</tr>
	            
	            	<tr>
	             		<td class="label" align="center" bgcolor=#FFDAB9> 주소 </td>
