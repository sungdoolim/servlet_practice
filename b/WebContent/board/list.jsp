...
"/Board.do?action=view&bbsno=${board.bbsno}&page=${page}"/>'>
${board.subject}</a></td>
...
<td>
<% 
Integer tempTotalPageCount =
(Integer)pageContext.getAttribute("totalPageCount",PageContext.REQUEST_SCOPE);
...
try{
	if(nowPageBlock>1){
		out.print("<a href=\"/Board.do?page="
	+(startPage-1)+"&action=list\">");
		out.print("◀</a>");	
	}
